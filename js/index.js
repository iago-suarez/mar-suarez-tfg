...
window.addEventListener('load', function () {
    ...
    var videoOutput = document.getElementById('video-player');
    var address = document.getElementById('address');
    //address.value = 'http://files.kurento.org/video/60sec/ball.webm';
    //TODO: Cambiar esto por tu ruta local
    address.value = 'file:///home/iago/workspace/mar-suarez-tfg/media/comprimido2.webm';

    /******************* Added by Iago *****************/
    var kurentoServer = document.getElementById('kurento-server');
    kurentoServer.value = 'ws://localhost:8888/kurento'
    args.ws_uri = kurentoServer.value
    /***************************************************/
    ...
    function onOffer(error, sdpOffer) {
        ...
        /******************* Added by Iago *****************/
        var serverInput = document.getElementById('kurento-server');
        if (serverInput.value != "") {
            args.ws_uri = serverInput.value;
        }
        /***************************************************/
